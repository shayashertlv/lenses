...
for (const name of ['face', 'capture', 'source', 'hairwait', 'hairinput', 'hairdelegate', 'hairz', 'sync', 'exposure', 'guard', 'continuity', 'hairrun', 'eyewear', 'hairModel', 'hair', 'diag', 'steady', 'steadyhz', 'steadybeta', 'steadydepthhz', 'steadydepthbeta', 'hairframes', 'hairmove', 'hairmaxage', 'fit']) if (option(name, '')) query.set(name, option(name, ''));
