...
for (const name of ['face', 'capture', 'hairwait', 'hairz', 'sync', 'exposure', 'guard', 'continuity', 'hairrun', 'eyewear', 'hairModel', 'hair', 'diag']) if (option(name, '')) query.set(name, option(name, ''));
