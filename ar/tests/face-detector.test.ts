...
import {DetectorClient} from '../src/face/detector.ts';
import type {FaceWorkerPort} from '../src/face/detector.ts';
import type {Detection} from '../src/face/protocol.ts';
import type {TimedDetectorRequest, TimedDetectorResponse, WorkerFaceTiming} from '../src/face/timing.ts';
