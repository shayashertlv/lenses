...
import { DEFAULT_EYEWEAR_ID, eyewearById, GLASSES_METERS_TO_CENTIMETERS } from '../../src/render/eyewear.ts';
import type { EyewearDefinition } from '../../src/render/eyewear.ts';
import { createTempleClip, createTempleBlendConfiguration } from '../../src/render/temple-clip.ts';
...
import { createTempleVisibility, createTempleVisibilityConfiguration, TEMPLE_VISIBILITY_METHOD,
  TEMPLE_VISIBILITY_PARAMETERS } from '../../src/render/temple-visibility.ts';
import type { TempleVisibilityConfiguration } from '../../src/render/temple-visibility.ts';
import {createRearDrop, rearDropForPose} from './rear-drop.ts';
import {REAR_DROP_METHOD, validateRearDrop} from './contracts.ts';
import type {RearDropConfiguration} from './contracts.ts';
export { GLASSES_METERS_TO_CENTIMETERS, GLASSES_OFFSET_CM } from '../../src/render/eyewear.ts';
