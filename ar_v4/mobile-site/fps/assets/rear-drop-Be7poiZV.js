...
}`)},e.customProgramCacheKey=()=>`${d===Ar.prototype.customProgramCacheKey?u.toString():d.call(e)}|${kd}|${Ad}|${jd}`,e.needsUpdate=!0}}),{get configuration(){return u?{...u}:null},set(e){if(d)throw Error(`Temple clipping is disposed.`);e!==null&&Nd(e),u=e===null?null:{...e},t.value=e===null?0:1,i.value=e?.method===`temple-end-fade-v2`||e?.method===`temple-end-blend-v3`?e.fadeLengthLocalM:0,a.value=e?.method===`temple-end-blend-v3`?3:e?.method===`temple-end-fade-v2`&&e.fadeLengthLocalM>0?e.coverage===`alpha-to-coverage`?1:2:0,o.value=null,e!==null&&(n.value=e.negativeXCutoffLocalZM,r.value=e.positiveXCutoffLocalZM)},prepareRender(e,t,n){if(d)throw Error(`Temple clipping is disposed.`);if(a.value===3){let r=e?.image;if(!(e instanceof ea)||e.colorSpace!==`srgb`||!r||!Number.isFinite(r.width)||!Number.isFinite(r.height)||!(r.width>0)||!(r.height>0)||!Number.isInteger(t)||!Number.isInteger(n)||!(t>0)||!(n>0))throw Error(`Temple blending requires the paired sRGB camera texture and valid render dimensions.`);if(e.matrixAutoUpdate&&e.updateMatrix(),!e.matrix.elements.every(Number.isFinite))throw Error(`The paired camera UV transform is invalid.`);o.value=e,s.value.set(t,n),c.value.copy(e.matrix)}for(let[e,t]of f){let n=a.value===1||t.alphaToCoverage;e.alphaToCoverage!==n&&(e.alphaToCoverage=n,e.needsUpdate=!0)}},dispose(){if(!d){d=!0,u=null,t.value=0,i.value=0,a.value=0,o.value=null;for(let[e,t]of f)e.onBeforeCompile=t.hook,e.customProgramCacheKey=t.key,e.alphaToCoverage=t.alphaToCoverage,e.needsUpdate=!0;f.clear()}}}}var Id=Object.freeze({maximumDropM:.03,defaultDropM:.02,proximalGuardM:.015,lateralMinM:.045,pitchStartDegrees:8,pitchFullDegrees:28,headYawStartDegrees:10,headYawEndDegrees:25,viewBearingStartDegrees:20,viewBearingEndDegrees:40});function Ld(e){if(!Number.isFinite(e)||e<0||e>Id.maximumDropM)throw Error(`Rear drop must be finite and between 0 and 0.03 meters.`)}function Rd(e,t,n,r){if(Ld(r),![e,t,n].every(Number.isFinite)||t<=n)throw Error(`The rear-drop span is invalid.`);let i=Dt.clamp((t-e)/(t-n),0,1);return{loweringM:r*i*i*(3-2*i),dyDz:r*6*i*(1-i)/(t-n)}}function zd(e,t=Id.defaultDropM){if(Ld(t),e.length!==16||!e.every(Number.isFinite))throw Error(`The rear-drop pose is invalid.`);let n=new Y().fromArray(e);if(Math.abs(n.determinant())<1e-12)throw Error(`The rear-drop pose is singular.`);let r=new G().applyMatrix4(n.clone().invert()),i=r.length(),a=Math.hypot(e[8],e[9],e[10]),o=Math.hypot(e[8],e[10]);if(i<1e-12||a<1e-12)throw Error(`The rear-drop viewing direction is invalid.`);let s=e=>Math.sin(Dt.degToRad(e)),c=-e[9]/a,l=r.y/i,u=Dt.smoothstep(Math.min(c,l),s(Id.pitchStartDegrees),s(Id.pitchFullDegrees)),d=o>1e-12?Math.abs(e[8])/o:1,f=1-Dt.smoothstep(d,s(Id.headYawStartDegrees),s(Id.headYawEndDegrees)),p=1-Dt.smoothstep(Math.abs(r.x)/i,s(Id.viewBearingStartDegrees),s(Id.viewBearingEndDegrees));return t*u*f*p}function Bd(e,t){if(e instanceof Or&&t instanceof Or)e.data.array.set(t.data.array),e.data.needsUpdate=!0;else if(e instanceof ur&&t instanceof ur)e.array.set(t.array),e.needsUpdate=!0;else throw Error(`The rear-drop geometry clone has incompatible attributes.`)}var Vd=e=>e instanceof va&&e.transmission>0;function Hd(e,t){if(!Number.isFinite(t)||t<-.2||t>-.03)throw Error(`The rear-drop endpoint is invalid.`);let n=new Map,r=[],i=1/0,a=0,o=!1;if(e.updateWorldMatrix(!0,!0),Math.abs(e.matrixWorld.determinant())<1e-12)throw Error(`The rear-drop root transform is singular.`);let s=e.matrixWorld.clone().invert();try{if(e.traverse(e=>{if(!(e instanceof Zr)||e.userData.templeVisibilityOverlay===!0)return;let t=e.geometry,a=t.getAttribute(`position`);if(!a||a.itemSize!==3)throw Error(`Rear-drop assets require three-component positions.`);let o=n.get(t);o||(o={original:t,clone:t.clone(),referenced:new Uint8Array(a.count),fixed:new Uint8Array(a.count),opaque:new Uint8Array(a.count),lens:new Uint8Array(a.count)},n.set(t,o));let c=Array.isArray(e.material)?e.material:[e.material],l=t.getIndex();for(let[n,r]of c.entries()){let s=Vd(r),c=!s&&!r.transparent,u=Array.isArray(e.material)?t.groups.filter(e=>e.materialIndex===n):[{start:0,count:l?.count??a.count}];for(let e of u)for(let t=e.start;t<e.start+e.count;t++){let e=l?l.getX(t):t;if(!Number.isInteger(e)||e<0||e>=a.count)throw Error(`The rear-drop mesh index is invalid.`);let n=a.getX(e),r=a.getY(e),u=a.getZ(e);if(![n,r,u].every(Number.isFinite))throw Error(`The rear-drop mesh contains invalid positions.`);o.referenced[e]=1,c||(o.fixed[e]=1),s&&(o.lens[e]=1,i=Math.min(i,u)),c&&(o.opaque[e]=1)}}let u=s.clone().multiply(e.matrixWorld);if(!u.elements.every((e,t)=>Math.abs(e-+(t%5==0))<=1e-12))throw Error(`Rear-drop curve thresholds require identity mesh transforms inside the asset root.`);r.push({mesh:e,geometry:o,toRoot:u})}),!Number.isFinite(i))throw Error(`Rear drop requires physical lens geometry to protect the optical front.`);let c=i-Id.proximalGuardM;if(c<=t)throw Error(`The rear-drop start must be forward of the accepted cap.`);let l=new Kn,u=[new Kn,new Kn],d=[new Kn,new Kn],f=(e,t)=>{let n=e.original.getAttribute(`position`);return e.opaque[t]===1&&e.fixed[t]===0&&Math.abs(n.getX(t))>Id.lateralMinM&&n.getZ(t)<c},p=0;for(let e of n.values())for(let t=0;t<e.opaque.length;t++)p+=Number(f(e,t));if(!p)throw Error(`The asset has no eligible posterior opaque shaft.`);let m=new G;for(let{geometry:e,toRoot:t}of r){let n=e.original.getAttribute(`position`);for(let r=0;r<n.count;r++)m.fromBufferAttribute(n,r).applyMatrix4(t),e.referenced[r]&&!f(e,r)&&l.expandByPoint(m),f(e,r)&&u[n.getX(r)<0?0:1].expandByPoint(m)}let h=()=>{d=[new Kn,new Kn];for(let{geometry:e,toRoot:t}of r){let n=e.clone.getAttribute(`position`);for(let r=0;r<n.count;r++)f(e,r)&&d[n.getX(r)<0?0:1].expandByPoint(m.fromBufferAttribute(n,r).applyMatrix4(t))}};for(let{mesh:e,geometry:t}of r)e.geometry=t.clone;return h(),{get opticalBounds(){return l.clone()},get originalArmBounds(){return u.filter(e=>!e.isEmpty()).map(e=>e.clone())},get candidateArmBounds(){return d.filter(e=>!e.isEmpty()).map(e=>e.clone())},get diagnostics(){return{method:`posterior-y-preview-curve-v1`,dropM:a,startZM:c,cutoffZM:t,lensRearZM:i,fadeLengthM:Md,affectedVertexCount:p,sourceGeometryCount:n.size,originalXAndZPreserved:!0,opticalFrontPreserved:!0,meshTransformIdentityChecked:!0,protectionIncludesAllUndeformedReferencedVertices:!0,interpretation:`Authored posterior Y curve; not a true hinge or measured wearer fit.`}},setDrop(e){if(o)throw Error(`Rear drop is disposed.`);if(Ld(e),e!==a){for(let r of n.values()){for(let e of[`position`,`normal`,`tangent`]){let t=r.original.getAttribute(e),n=r.clone.getAttribute(e);t&&n&&Bd(n,t)}if(e>0){let n=r.original.getAttribute(`position`),i=r.clone.getAttribute(`position`),a=r.original.getAttribute(`normal`),o=r.clone.getAttribute(`normal`),s=r.original.getAttribute(`tangent`),l=r.clone.getAttribute(`tangent`);for(let u=0;u<i.count;u++){if(!f(r,u))continue;let d=Rd(n.getZ(u),c,t,e);i.setY(u,n.getY(u)-d.loweringM),d.dyDz!==0&&o&&a&&(m.set(a.getX(u),a.getY(u),a.getZ(u)-d.dyDz*a.getY(u)).normalize(),o.setXYZ(u,m.x,m.y,m.z)),d.dyDz!==0&&l&&s&&(m.set(s.getX(u),s.getY(u)+d.dyDz*s.getZ(u),s.getZ(u)).normalize(),l.setXYZ(u,m.x,m.y,m.z))}}r.clone.computeBoundingBox(),r.clone.computeBoundingSphere()}a=e,h()}},dispose(){if(o)return;o=!0;let t=new Map([...n.values()].map(e=>[e.clone,e.original]));e.traverse(e=>{if(e instanceof Zr){let n=t.get(e.geometry);n&&(e.geometry=n)}});for(let{mesh:e,geometry:t}of r)e.geometry===t.clone&&(e.geometry=t.original);for(let e of n.values())e.clone.dispose()}}}catch(e){for(let{mesh:e,geometry:t}of r)e.geometry===t.clone&&(e.geometry=t.original);for(let e of n.values())e.clone.dispose();throw e}}var Ud=`temple-rear-drop-v1`;function Wd(e){if(!e||e.method!==`temple-rear-drop-v1`||!Number.isFinite(e.dropM)||e.dropM<0||e.dropM>.03)throw Error(`The saved rear-drop configuration is invalid.`)}function Gd(e,t,n){if(!e||e.method!==`temple-optics-copy-v1`||e.width!==t||e.height!==n||!Number.isInteger(t)||!Number.isInteger(n)||t<=0||n<=0||!Number.isFinite(e.marginPx)||e.marginPx<3||e.marginPx>64||!Array.isArray(e.protectedRects)||e.protectedRects.length<2||e.protectedRects.length>8||!Array.isArray(e.editableRects)||e.editableRects.length>4)throw Error(`The saved temple protection is invalid.`);for(let r of[...e.protectedRects,...e.editableRects])if(!r||![r.x0,r.y0,r.x1,r.y1].every(Number.isInteger)||r.x0<0||r.y0<0||r.x1>t||r.y1>n||r.x1<=r.x0||r.y1<=r.y0)throw Error(`The saved temple protection rectangle is invalid.`)}var Kd=[1,2,4,6,33,98,133,168,197,263,327,362];function qd(e,t,n){let r=new uo(od.verticalFovDegrees,n,od.nearCm,od.farCm),i=new Y().makeTranslation(...t).scale(new G().setScalar(100));return r.projectionMatrix.clone().multiply(new Y().fromArray(e)).multiply(i)}function Jd(e,t,n,r,i){if(e.isEmpty()||![...e.min.toArray(),...e.max.toArray(),...t.elements].every(Number.isFinite))throw Error(`The projected temple bounds are invalid.`);let a=1/0,o=1/0,s=-1/0,c=-1/0;for(let i of[e.min.x,e.max.x])for(let l of[e.min.y,e.max.y])for(let u of[e.min.z,e.max.z]){let e=new J(i,l,u,1).applyMatrix4(t);if(e.w<=od.nearCm||e.z<-e.w||!e.toArray().every(Number.isFinite))throw Error(`The temple bounds cross the projection near plane.`);let d=(e.x/e.w+1)*n/2,f=(1-e.y/e.w)*r/2;a=Math.min(a,d),s=Math.max(s,d),o=Math.min(o,f),c=Math.max(c,f)}return Yd(a,o,s,c,n,r,i)}function Yd(e,t,n,r,i,a,o){let s={x0:Math.max(0,Math.floor(e-o)),y0:Math.max(0,Math.floor(t-o)),x1:Math.min(i,Math.ceil(n+o)),y1:Math.min(a,Math.ceil(r+o))};return s.x1>s.x0&&s.y1>s.y0?s:null}function Xd(e,t,n,r,i,a,o=i/a){try{if(!Number.isInteger(i)||!Number.isInteger(a)||i<=0||a<=0||t.length!==16||!t.every(Number.isFinite)||!n.every(Number.isFinite)||r.length<468||!Number.isFinite(o)||o<=0)return null;let s=qd(t,n,o),c=Jd(e.optical,s,i,a,4);if(!c)return null;let l=Kd.map(e=>r[e]);if(l.some(e=>!e||!Number.isFinite(e.x)||!Number.isFinite(e.y)))return null;let u=l.map(e=>e.x*i),d=l.map(e=>e.y*a),f=Math.max(4,(Math.max(...u)-Math.min(...u))*.08),p=Yd(Math.min(...u),Math.min(...d),Math.max(...u),Math.max(...d),i,a,f);if(!p||e.originalArms.length!==e.candidateArms.length||e.originalArms.length>2)return null;let m=[];for(let t=0;t<e.originalArms.length;t++){let n=Jd(e.originalArms[t].clone().union(e.candidateArms[t]),s,i,a,4);n&&m.push(n)}let h={method:`temple-optics-copy-v1`,width:i,height:a,marginPx:4,protectedRects:[c,p],editableRects:m};return Gd(h,i,a),h}catch{return null}}function Zd(e,t,n){if(!e||e.method!==`temple-optics-copy-v1`||e.width!==t||e.height!==n||!Number.isInteger(t)||!Number.isInteger(n)||t<=0||n<=0||!Number.isFinite(e.marginPx)||e.marginPx<3||e.marginPx>64||!Array.isArray(e.protectedRects)||e.protectedRects.length<2||e.protectedRects.length>8||!Array.isArray(e.editableRects)||e.editableRects.length>4)throw Error(`The saved temple protection is invalid.`);for(let r of[...e.protectedRects,...e.editableRects])if(!r||![r.x0,r.y0,r.x1,r.y1].every(Number.isInteger)||r.x0<0||r.y0<0||r.x1>t||r.y1>n||r.x1<=r.x0||r.y1<=r.y0)throw Error(`The saved temple protection rectangle is invalid.`)}function Qd(e,t,n){let r=new uo(od.verticalFovDegrees,n,od.nearCm,od.farCm),i=new Y().makeTranslation(...t).scale(new G().setScalar(100));return r.projectionMatrix.clone().multiply(new Y().fromArray(e)).multiply(i)}var $d=Object.freeze({maximumDropM:.03,defaultDropM:.02,proximalGuardM:.015,lateralMinM:.045,pitchStartDegrees:8,pitchFullDegrees:28,headYawStartDegrees:10,headYawEndDegrees:25,viewBearingStartDegrees:20,viewBearingEndDegrees:40});function ef(e){if(!Number.isFinite(e)||e<0||e>$d.maximumDropM)throw Error(`Rear drop must be finite and between 0 and 0.03 meters.`)}function tf(e,t,n,r){if(ef(r),![e,t,n].every(Number.isFinite)||t<=n)throw Error(`The rear-drop span is invalid.`);let i=Dt.clamp((t-e)/(t-n),0,1);return{loweringM:r*i*i*(3-2*i),dyDz:r*6*i*(1-i)/(t-n)}}export{Cn as A,uo as B,ur as C,ta as D,X as E,Y as F,Wt as G,jn as H,Zr as I,G as J,h as K,zr as L,Ar as M,Dt as N,vo as O,K as P,va as R,tu as S,ea as T,ha as U,ze as V,oa as W,Kt as X,J as Y,fd as _,qd as a,au as b,Wd as c,Pd as d,Fd as f,vd as g,Od as h,Xd as i,s as j,Ge as k,Hd as l,bd as m,Qd as n,Ud as o,yd as p,W as q,Zd as r,Gd as s,tf as t,zd as u,od as v,Tr as w,cs as x,id as y,i as z};