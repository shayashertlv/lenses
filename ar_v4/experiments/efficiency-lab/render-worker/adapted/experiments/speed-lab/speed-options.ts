...
export function createOwnedSourceFrame(canvas: OffscreenCanvas, rgba: ImageData,
...
export function assertSourceFrameCurrent(source: OwnedSourceFrame, frame?: OffscreenCanvas, sourceSHA256?: string): void {
