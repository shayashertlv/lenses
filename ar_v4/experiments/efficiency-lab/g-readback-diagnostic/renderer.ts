...
import {DEFAULT_SPEED_OPTIONS, normalizeSpeedOptions, assertSourceFrameCurrent, sourcePixelsOpaque} from '../../speed-lab/speed-options.ts';
import type {NativeSpeedOptions, OwnedSourceFrame, SpeedFrameInput} from '../../speed-lab/speed-options.ts';
