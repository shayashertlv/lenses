...
import type {PboReadbackMetrics} from './pbo-readback.ts';
import {sourceCameraEligibility} from '../../../speed-lab/native/source-camera.ts';
import {DEFAULT_SPEED_OPTIONS, normalizeSpeedOptions} from '../../../speed-lab/speed-options.ts';
import type {NativeSpeedOptions, OwnedSourceFrame} from '../../../speed-lab/speed-options.ts';
...
export class TryOnRenderer {
  ...
  private presentInternal(frame: HTMLCanvasElement, detection: Detection, recordedSurface?: readonly number[],
    recordedTempleClip?: TempleClipConfiguration | null,
