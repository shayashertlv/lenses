...
import {checkProtocol,mechanismUse,PREWARM_REASON,expectedBranchRegion} from './protocol.mjs';
...
test('exact G readbacks and new mechanisms retain all transfers and first-use prewarm costs', () => {
  for (const name of ['scratch','temples','combined','deferred','region','lens']) for (const drop of [0,.02]) for (const first of [true,false]) {
