...
function updateControls(): void {
  ...
  element('hold-hint').textContent = held
    ? 'Camera stopped. All three versions show this exact held image. Resume starts a fresh live session.'
...
download.addEventListener('click', () => {
  ...
  try {
    ...
    element('download-status').textContent = 'Comparison downloaded locally. It includes the original image and all three outputs.';
