...
import { convertVolumeAttenuationUnits } from './eyewear-volume.ts';
import { createTemplePartPolicy } from './temple-parts.ts';
import { createTrialTempleVisibility } from './trial-temple-visibility.ts';
...
export class TryOnRenderer {
  ...
  private configure(face: CanonicalFace, eyewearScene: Group): void {
    ...
    convertVolumeAttenuationUnits(eyewearScene, this.eyewear.volumeAttenuationScale);
    ...
    const templeParts = this.eyewear.semanticTempleParts ? createTemplePartPolicy(eyewearScene) : undefined;
    this.templeClip = createTempleClip(eyewearScene, templeParts?.isLens);
    ...
    this.templeVisibility = templeParts
      ? createTrialTempleVisibility(eyewearScene, visibilityContext, templeParts.isLens)
      : createTempleVisibility(eyewearScene, visibilityContext);
