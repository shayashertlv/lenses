...
const CANDIDATE_REVISION = 'Performance Test 2: shared native camera context with two direct readbacks';
    ...
    try {
      ...
      this.latestStats = {sequence: this.sequence, hasFace, hasMask: false, maskOutputMode: null, maskStatus: hasFace ? 'missing' : 'no-face',
        ...
        candidatePerformance: {acceptedPixelReadbacksAvoided: 1, acceptedPixelBytesBorrowed: ownedPixels.data.byteLength,
          ...
          nativePipeline, cpuReadbackCalls: nativePipeline.baselineReadbackCalls + nativePipeline.branchReadbackCalls + (sharedReadback?.readbackCalls ?? 0),
          cpuReadbackBytes: nativePipeline.baselineReadbackBytes + nativePipeline.branchReadbackBytes + (sharedReadback?.readbackBytes ?? 0),
