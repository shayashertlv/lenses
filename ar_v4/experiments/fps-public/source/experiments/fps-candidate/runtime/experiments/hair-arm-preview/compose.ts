...
export interface PairIdentity {sourceIdentity: string; detectionIdentity: string; eyewearModel: string;}
export interface HairMask {
  sourceIdentity: string; detectionIdentity: string; model: string; modelSHA256: string;
