...
output_root = (workspace / 'experiments/performance-stage2/qa/output').resolve()
assert report_path.is_relative_to(output_root), 'Audit output must remain in candidate QA output.'
report_bytes = report_path.read_bytes()
report = json.loads(report_bytes)
assert report['schema'] == 'ar-performance-stage2-matched-v1'
...
receipt = {'schema': 'ar-performance-stage2-independent-png-v1', 'complete': True, 'passed': True,
           'scope': report['scope'],
