...
export class FrameProfiler {
  ...
  snapshot(): Record<string, unknown> {
    const run=this.benchmark;
    return {schema:'ar-speed-lab-performance-v1',...CURRENT_BASE_METADATA,baseCommit:'8baa16c9ffae945130b936821d5948c2f1cac720',timeOriginMs:performance.timeOrigin,
