...
import type {CaptureGeometry as AcceptedGeometry} from './temples/renderer.ts';
...
const CANDIDATE_REVISION = 'Performance candidate: reduced rendering, copies and allocations';
