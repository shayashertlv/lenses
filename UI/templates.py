...
<div id="form-view">
  ...
  <div class="tile-grid">
    ...
    <label class="tile"><input type="radio" name="lens_type" value="blue-light-filter"/><div class="tile-inner"><div class="lens-ind" style="width:26px;height:26px;background:rgba(255,245,220,.2);border-color:rgba(232,213,160,.4)"></div><span class="tile-label">Blue Light</span></div></label>
...
<div id="form-view">
  ...
  <div class="color-pick-grid" id="color-grid">
    ...
    <label class="color-pick"><input type="checkbox" name="lens_color" value="Clear (Transparent)"/><div class="color-pick-inner"><div class="color-swatch" style="background:linear-gradient(135deg,rgba(255,255,255,.15),rgba(255,255,255,.35));border:2px dashed rgba(255,255,255,.4)"></div><span class="color-pick-name">Clear</span></div></label>
